...
[![Portfolio](https://img.shields.io/badge/PORTFOLIO-DC2626?style=for-the-badge&logo=vercel&logoColor=white)](https://k48w.vercel.app/)
[![GitHub](https://img.shields.io/badge/GITHUB-111111?style=for-the-badge&logo=github&logoColor=white)](https://github.com/k48w)
[![Repositories](https://img.shields.io/badge/REPOSITORIES-7F1D1D?style=for-the-badge&logo=git&logoColor=white)](https://github.com/k48w?tab=repositories)

<br/><br/>

![Profile Views](https://komarev.com/ghpvc/?username=k48w&style=flat-square&color=DC2626&label=PROFILE+VIEWS)
[![Followers](https://img.shields.io/github/followers/k48w?style=flat-square&color=DC2626&labelColor=111111&logo=github&label=FOLLOWERS)](https://github.com/k48w?tab=followers)
[![Stars](https://img.shields.io/github/stars/k48w?affiliations=OWNER%2CCOLLABORATOR&style=flat-square&color=B91C1C&labelColor=111111&logo=github&label=STARS)](https://github.com/k48w?tab=repositories)
...
[![Languages](https://skillicons.dev/icons?i=cs,ts,js,python,cpp,lua,bash,powershell&theme=dark&perline=8)](https://skillicons.dev)
...
[![Frontend](https://skillicons.dev/icons?i=react,nextjs,vite,html,css,tailwind&theme=dark&perline=6)](https://skillicons.dev)
...
[![Backend](https://skillicons.dev/icons?i=nodejs,express,fastapi,flask,postgres,mysql,sqlite,mongodb,redis&theme=dark&perline=9)](https://skillicons.dev)
...
[![Tooling](https://skillicons.dev/icons?i=git,github,docker,linux,windows,vscode,visualstudio,cmake,npm,pnpm&theme=dark&perline=10)](https://skillicons.dev)
...
Hercules is my main engineering project and my strongest environment for learning real software development through architecture, iteration, debugging, and product thinking.

| Category | Details |
|:---|:---|
| **Stack** | C# · Application Development · Software Architecture |
| **Stage** | Active Development |
| **Focus** | Architecture, maintainability, product workflows, modularity, and developer experience |
| **Performance** | Reduce unnecessary work, improve responsiveness, and keep the system easier to reason about |
| **Reliability** | Better boundaries, clearer configuration, structured debugging, and safer feature evolution |
| **Impact** | A long-term project for learning how complex software grows and how to keep it under control |
| **Repository** | [github.com/k48w/Hercules](https://github.com/k48w/Hercules) |
...
<details>
<summary><strong>hercules-ai</strong></summary>

<br/>

hercules-ai is the AI-focused side of the Hercules ecosystem, created to explore how intelligent systems can be integrated into real software products.

| Category | Details |
|:---|:---|
| **Stack** | TypeScript · AI Workflows · Modern Web Tooling |
| **Stage** | Experimental Development |
| **Focus** | LLM workflows, intelligent automation, developer tooling, and AI product integration |
| **Performance** | Practical execution paths, reduced unnecessary processing, and simpler system behavior |
| **Reliability** | Structured data, explicit boundaries, safer integration patterns, and visible diagnostics |
| **Impact** | A dedicated space for learning AI-first software engineering |
| **Repository** | [github.com/k48w/hercules-ai](https://github.com/k48w/hercules-ai) |
...
**Personal Projects · Technical Research · Continuous Learning**  
`Ongoing`
...
- Design and evolve personal software projects.
- Study architecture patterns and apply them to real codebases.
- Build web, desktop, automation, and AI-related experiments.
- Integrate APIs and AI services into software systems.
- Debug complex behavior across different application layers.
- Improve UX while also improving internal architecture.
- Research unfamiliar technologies before implementing them.
- Use GitHub as a public engineering portfolio.
- Study open-source repositories to understand real-world patterns.
- Continuously refactor projects as my understanding improves.

### Skills Practiced

`C#` `TypeScript` `JavaScript` `Python` `React` `Next.js` `AI Systems` `Automation` `Architecture` `Git` `Product Engineering`
...
| Recognition | Details |
|:---|:---|
| **Built Beyond Tutorials** | Moving from isolated learning exercises toward larger, evolving software systems |
| **Multi-Stack Development** | Working across C#, TypeScript, JavaScript, Python, frontend development, automation, and AI systems |
| **Architecture Mindset** | Actively studying maintainability, modularity, boundaries, technical debt, and system evolution |
| **AI-First Exploration** | Experimenting with LLM integrations, automation, AI tooling, and intelligent workflows |
| **Product-Oriented Thinking** | Connecting code, UX, architecture, performance, and practical usability |
| **Continuous Iteration** | Reviewing projects, finding weak points, improving structure, and learning from mistakes |
...
![LLM Engineering](https://img.shields.io/badge/LLM_Engineering-111111?style=flat-square&logo=githubcopilot&logoColor=white&labelColor=991B1B)
![AI Agents](https://img.shields.io/badge/AI_Agents-111111?style=flat-square&logo=dependabot&logoColor=white&labelColor=B91C1C)
...
<img width="58%" src="https://github-readme-stats.vercel.app/api/top-langs/?username=k48w&layout=compact&hide_border=true&bg_color=050505&title_color=F87171&text_color=F5F5F5&langs_count=10" />
...
<img width="100%" src="https://github-readme-activity-graph.vercel.app/graph?username=k48w&bg_color=050505&color=F5F5F5&line=DC2626&point=F87171&area=true&area_color=7F1D1D&hide_border=true&custom_title=Contribution%20Activity" />
...
```txt
01. Build things that force real learning.
02. Prefer clarity over cleverness.
03. Make the system easier to change.
04. Do not hide weak architecture behind good UI.
05. Do not hide bad UX behind good code.
06. Debug deeply instead of guessing randomly.
07. Improve the project every time you touch it.
08. Treat documentation as part of the product.
09. Learn from stronger codebases.
10. Keep building.
```
...
**Build difficult things. Learn from the mess. Refactor into something better.**
